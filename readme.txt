=== Schema Extensions for Yoast SEO by WP Munich ===
Contributors: wpmunich,luehrsen
Tags: yoast,seo,schema,structured data
...
Extend the Schema.org markup generated by Yoast SEO in small, but meaningful ways.
...
1. Search for 'Schema Extensions for Yoast SEO by WP Munich'
1. Activate the plugin from your Plugins page.

= Manually =

1. Upload the 'wpm-schema' folder to the `/wp-content/plugins/` directory
